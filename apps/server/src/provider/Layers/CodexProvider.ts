// @effect-diagnostics nodeBuiltinImport:off - Codex auth.json lives outside Effect's service boundary and is read only to identify the native workspace.
...
export function resolveCodexAuthHome(
  input: { readonly homePath?: string; readonly environment?: NodeJS.ProcessEnv },
