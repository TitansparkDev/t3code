...
/** Render message text without Markdown syntax while keeping readable blocks and lists. */
export function markdownPlainText(markdown: string): string {
  ...
  return render(parser.parse(markdown) as unknown as MarkdownNode).trim();
}
